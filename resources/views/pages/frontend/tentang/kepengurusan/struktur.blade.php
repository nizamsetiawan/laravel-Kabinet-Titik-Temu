                    ...
                    <div class="col-auto">
                        ...
                        <div data-anim="slide-up delay-2 ">
                            <h1 class="page-header__title text-24">
                                STRUKTUR KEPENGURUSAN<br>BADAN EKSEKUTIF MAHASISWA UNIVERSITAS NEGERI SURABAYA
                            </h1>
                        </div>
                ...
                @foreach ($struktur->utama as $utama)
                    <tr>
                        ...
                        <td style="border: 0; " class="py-10 px-3 text-18 fw-500 text-purple-1">
                            @php
                                $url = $utama->pejabat->user->username
                                    ? url($utama->pejabat->user->username)
                                    : route('anggota.id', $utama->pejabat->id);
                            @endphp
                                ...
                                <td style="border: 0;" class="py-10 px-3 text-18 fw-500 text-purple-1">
                                    @if (isset($body->pejabat[0]))
                                        @php
                                            ...
                                            $url = $pejabat->anggota->user->username
                                                ? url($pejabat->anggota->user->username)
                                                : route('anggota.id', $pejabat->anggota->id);
                                        @endphp
                                        <a href="{{ $url }}">
