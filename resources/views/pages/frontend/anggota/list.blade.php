                                        ...
                                        @php
                                            $province = $item->province
                                                ? '<a class="text-purple-1" href="' .
                                                    url('anggota?search=' . $item->province) .
                                                    '">' .
                                                    $item->province .
                                                    '</a>'
                                                : '';
                                            $regencie = $item->regencie
                                                ? '<a class="text-purple-1" href="' .
                                                    url('anggota?search=' . $item->regencie) .
                                                    '">' .
                                                    $item->regencie .
                                                    '</a>'
                                                : '';
                                            $district = $item->district
                                                ? '<a class="text-purple-1" href="' .
                                                    url('anggota?search=' . $item->district) .
                                                    '">' .
                                                    $item->district .
                                                    '</a>'
                                                : '';
                                            $village = $item->village
                                                ? '<a class="text-purple-1" href="' .
                                                    url('anggota?search=' . $item->village) .
                                                    '">' .
                                                    $item->village .
                                                    '</a>'
                                                : '';
                                            ...
                                            $alamat_lengkap .=
                                                $alamat_lengkap == ''
                                                    ...
                                                    : ($district == ''
                                                        ...
                                                        : ", $district");
                                            $alamat_lengkap .=
                                                $alamat_lengkap == '' ? $village : ($village == '' ? '' : ", $village");
                                        @endphp
                                    </small>
                                    <small class="text-muted">
                                        {!! $alamat_lengkap !!}
