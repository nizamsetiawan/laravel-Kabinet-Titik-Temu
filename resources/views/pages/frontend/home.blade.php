...
@section('content')
    @php
        ...
        $k = "$p.hero";
        $filter = [
            ['search' => '__periode_nama__', 'replace' => $periode->nama],
            ['search' => '__periode_dari__', 'replace' => $periode->dari],
            ['search' => '__periode_sampai__', 'replace' => $periode->sampai],
        ];
        $anim = 1;
    @endphp
    ...
    @endphp
    @if (settings()->get("$k.visible"))
        <section class="layout-pt-md layout-pb-md " style="background-color: #F6DAA6;" data-anim-wrap>
            <div class="container">
